...
| --- | --- | --- | --- | --- |
| `node-a-feature-export` | `feature_ndjson` | `2690 windows` | `2693676` | `not included in the public bundle; summarized here` |
| `node-b-feature-export` | `feature_ndjson` | `2690 windows` | `2667927` | `not included in the public bundle; summarized here` |
| `node-c-feature-export` | `feature_ndjson` | `2640 windows` | `2688156` | `not included in the public bundle; summarized here` |
| `node-c-protected-traffic` | `traffic_ndjson` | `11180 samples / 5590 throughput` | `4488244` | `not included in the public bundle; summarized here` |
| `controller-decisions` | `controller_ndjson` | `2640 decisions` | `2179765` | `not included in the public bundle; summarized here` |
